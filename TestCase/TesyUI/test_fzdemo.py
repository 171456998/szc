...
class TestFirstUIDemo:
    def test_demo(self,driver):
        ...
        # 点击属性类型
        base.click('点击属性类型',"(//label[contains(text(),'属性类型')]/following-sibling::div//span)[1]")
        # 选择配件
        base.click('选择配件',"//span[text()='服装-裤装']")
        # 填写颜色
        base.send_keys('填写颜色',"(//label[contains(text(),'商品规格')]/following-sibling::div//input)[1]",'蓝色')
        # 点击尺码
        base.click('点击尺码',"(//label[contains(text(),'商品规格')]/following-sibling::div//span)[5]")
        # 点击增加
        base.click('点击增加',"(//label[contains(text(),'商品规格')]/following-sibling::div//span)[1]")
        time.sleep(2)
